//ENTREGA MOVIMIENTO ABIGAIL REYES 202312353

//en este ejercicio quise hacer que el ejercicio de mi entrega inicial
//se moviera de un lado al otro, y tambien hice cambio de colores del
//fondo definiendo variables
